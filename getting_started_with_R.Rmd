...
- The function `read.csv('albemarle_homes.csv')` tells R to import a CSV file named 'alb_homes.csv'. Where does it look for it?
...
- In this workshop will work through and review a R script I have already written: `Intro_R_2021.R`
...
Let's open the R script `Intrp_R_2021.R`
